...
function NewQuestion(props) {
  ...
  function handleSubmit(e) {
    ...
    if (!optionOneText || !optionTwoText) {
      console.error("Please add 2 Options to continue");
      return;
    }
    props.dispatch(
      handleAddQuestion(optionOneText, optionTwoText, loggedInUser)
    );
    setToHome(true);
  }
  ...
  return (
    <div className="container box">
      <div className="center new-question">Create New Question</div>
      <div className="container box">
